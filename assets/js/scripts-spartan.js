jQuery(document).on('click', '#cme_activalist', function(event){ // use jQuery no conflict methods replace $ with "jQuery"
  ...
  jQuery.ajax({
      ...
      beforeSend: function() {
        ...
        jQuery(".cme-custom-fields .spinner").css('visibility', 'visible');
        // alert('before');
      ...
      success: function(response){ // response //data, textStatus, jqXHR
        ...
        if (valor === '1') {
          ...
          jQuery("#cme_apivalid .chmm").removeClass("invalid").addClass("valid");
          jQuery("#cme_apivalid .dashicons").removeClass("dashicons-no").addClass( "dashicons-yes" );
          ...
          jQuery("#cme_apivalid .chmm").removeClass("valid").addClass("invalid");
          jQuery("#cme_apivalid .dashicons").removeClass("dashicons-yes").addClass( "dashicons-no" );
